...
<div class="templatemo-content-widget white-bg col-2">
    ...
    <h2 class="templatemo-inline-block">${good.goodname} <span style="color: grey">${good.price}￥</span><a href="chatRoom/chatRoom.jsp?salerId=${good.saler}" target="_blank"><span class="badge" >私聊卖家</span></a></h2><hr>
